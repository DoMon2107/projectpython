...
class MainWindow(tk.Tk):
    ...
    def setup_ui(self):
        ...
        self.tableWidget.place(x=440, y=400)
        ...
        self.pushButton_6.place(x=440, y=760)
    ...
    def add_hd(self):
        ...
        if success:
            ...
            messagebox.showerror("Lỗi", "Không thể thêm hóa đơn cthd!")
